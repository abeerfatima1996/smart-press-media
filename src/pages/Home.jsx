...
const Home = () => {
    return (
        <>
            ...
            <div className="container mx-auto  lg:hidden flex flex-col items-center justify-center py-4 px-5 mt-5 ">
                {/* Left Section */}
                <div className="text-center md:text-left">
                ...
                {/* Image */}
                <img src={banner} alt="Banner" className="h-[400px] w-auto mb-8" />
            ...
            {/* Paragraph */}
            <div className='container mx-auto flex justify-center items-center text-center px-5 sm:px-14 lg:px-28 mt-24'>
            ...
            <div className="container mx-auto mt-20 px-5 sm:px-10">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-x-24">
                    ...
                    <p className="mt-6 sm:mt-10 font-noto text-base sm:text-lg leading-relaxed">
                        Lorem ipsum dolor sit amet consectetur. Lacinia etiam elementum
                        senectus ac integer. Elit nisi platea aliquet viverra.
                    </p>
            ...
            {/*More Books  */}
            <div className='container mx-auto flex flex-col justify-center items-center mt-10 px-5 text-center'>
                <h2 className='text-4xl md:text-6xl'>More Books to Read</h2>
                <p className='mt-10 text-md font-noto max-w-[600px]  md:mx-0'>
