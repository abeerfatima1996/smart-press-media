    ...
    <>
      ...
      <div className='bg-black'>
        ...
        <div className="flex lg:justify-center sm:justify-end">
          <img src={logo} alt="Logo" className="h-20 w-[249px]" />
        </div>
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden fixed top-0 left-0 w-full bg-black text-white py-4 z-50 transition-transform duration-300 ease-in-out ${
