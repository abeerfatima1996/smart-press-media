...
const Blogs = ({ src, date, comments, title, description,commentIcon,readMoreColor = "text-[#D1B271]" }) => {
  return (
      ...
      <div className="px-6 py-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-3 mt-2">
            <p className={`${readMoreColor} cursor-pointer hover:underline`}>Read More</p>
